...
class CreateComment(CanCreateMixin, BaseCommentView):
    ...
    def form_valid(self, form):
        ...
        # if author_email:
        #     email = EmailMessage(
        #                 'comment', 'new comment for article {} who you are the owner\
        #                      the article:\n{}{}'.format(article, current_site, reverse
        #                      ('core:detail', args=[article.slug, article.id])
        #                      ), to=[author_email]
        #     )
        # if user_email:
        #     email = EmailMessage(
        #                 'comment', 'your comment has been receive and soon we response it'
        #                     , to=[user_email]
        #     )
        # if parent_email:
        #     email = EmailMessage(
        #                 'new comment', 'new comment for your comment inarticle {} \
        #                      for see the comment click on this link:\n{}{}'.format(article, current_site, reverse
        #                      ('core:detail', args=[article.slug, article.id])
        #                      ), to=[parent_email]
        #     )
